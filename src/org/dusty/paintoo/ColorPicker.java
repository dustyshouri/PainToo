...
import se.deas.paintoo.handlers.FrameDisposable;

public class ColorPicker extends JDialog {
  private static final long serialVersionUID = 1L;

  private Color[] defaultColors = { new Color( 255, 128, 128 ), new Color( 255, 255, 128 ), new Color( 128, 255, 128 ), new Color( 0, 255, 128 ),
      new Color( 128, 255, 255 ), new Color( 0, 128, 255 ), new Color( 255, 128, 192 ), new Color( 255, 128, 255 ),

      new Color( 255, 0, 0 ), new Color( 255, 255, 0 ), new Color( 128, 255, 0 ), new Color( 0, 255, 64 ), new Color( 0, 255, 255 ),
      new Color( 0, 128, 192 ),
      ...
      // TEMP    
      new Color( 255, 128, 128 ), new Color( 255, 255, 128 ), new Color( 128, 255, 128 ), new Color( 0, 255, 128 ), new Color( 128, 255, 255 ),
      new Color( 0, 128, 255 ), new Color( 255, 128, 192 ), new Color( 255, 128, 255 ), new Color( 255, 0, 0 ), new Color( 255, 255, 0 ),
      new Color( 128, 255, 0 ), new Color( 0, 255, 64 ), new Color( 0, 255, 255 ), new Color( 0, 128, 192 ), new Color( 128, 128, 192 ),
      new Color( 255, 0, 255 ), new Color( 128, 64, 64 ), new Color( 255, 128, 64 ), new Color( 0, 255, 0 ), new Color( 0, 128, 128 ), new Color( 0, 64, 128 ),
      new Color( 128, 128, 255 ), new Color( 128, 0, 64 ), new Color( 255, 0, 128 ), new Color( 255, 128, 128 ), new Color( 255, 255, 128 ),
      new Color( 128, 255, 128 ), new Color( 0, 255, 128 ), new Color( 128, 255, 255 ), new Color( 0, 128, 255 ), new Color( 255, 128, 192 ),
      new Color( 255, 128, 255 ), new Color( 255, 0, 0 ), new Color( 255, 255, 0 ), new Color( 128, 255, 0 ), new Color( 0, 255, 64 ),
      new Color( 0, 255, 255 ), new Color( 0, 128, 192 ), new Color( 128, 128, 192 ), new Color( 255, 0, 255 ), new Color( 128, 64, 64 ),
      new Color( 255, 128, 64 ), new Color( 0, 255, 0 ), new Color( 0, 128, 128 ), new Color( 0, 64, 128 ), new Color( 128, 128, 255 ),
      new Color( 128, 0, 64 ), new Color( 255, 0, 128 ), new Color( 0, 64, 128 ), new Color( 128, 128, 255 ), new Color( 128, 0, 64 ),
      new Color( 255, 0, 128 ), new Color( 0, 64, 128 ), new Color( 128, 128, 255 ), new Color( 128, 0, 64 ), new Color( 255, 0, 128 ),
  ...
  public ColorPicker( JFrame parent ) {
    ...
    okayButton.addActionListener( new FrameDisposable( this ) );
    add( okayButton );

    // 'Cancel' button
    JButton cancelButton = new JButton( "Cancel" );
    cancelButton.setBounds( insets.left + 78, insets.top + 245, 66, 23 );
    cancelButton.addActionListener( new FrameDisposable( this ) );
    add( cancelButton );
